      ...
      items: [
        {
          id: 1,
          name: 'Sahabat Muslim',
          imageUrl: 'portfolio-sahabatmuslim.png',
        ...
        },
        {
          id: 2,
          name: 'SISTEKDES',
          imageUrl: 'portfolio-sistekdes.png',
        ...
        },
        {
          ...
          name: 'SHOPe',
          imageUrl: 'tesss.svg', 
          status: 'SHOPe is a modern e-commerce application that provides users with a seamless shopping experience. With an intuitive and visually appealing UI, users can explore, search, and purchase various products effortlessly.',
          tech: 'Dart, Flutter',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          name: 'ChairMerce',
          imageUrl: 'ecom.svg', 
          status: 'ChairMerce is a furniture-focused e-commerce application that helps users find, compare, and buy high-quality chairs and home decor items. Its sleek and minimalist design enhances the online shopping experience.',
          tech: 'Dart, Flutter',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          name: 'PhotoHub',
          imageUrl: 'hub2.svg', 
          status: 'PhotoHub is a photography-centric platform that allows users to upload, share, and monetize their photos. Designed for photographers and visual artists, the app offers a digital space to showcase creativity.',
          tech: 'Dart, Flutter',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          name: 'Starbucks',
          imageUrl: 'start.svg', 
          status: 'Starbucks Clone is a mobile ordering application for coffee lovers. Users can browse the menu, place orders, and locate nearby stores for a quick and convenient coffee pickup experience.',
          tech: 'Dart, Flutter',
          github: 'null',
          demo: 'null'
        }
