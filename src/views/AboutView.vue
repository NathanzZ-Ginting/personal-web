    ...
    return {
      ...
      tools: [
        ...
        },
        {
          ...
          status: 'Android Development',
        },
        {
          id: 11,
          name: 'Xcode',
          imageUrl: 'xc.png',
          status: 'Mobile Simulator',
        }
      ]
    };
  }
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="nathan.png" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; I am Joenathan Haganta Ginting, a Fullstack Developer, Software Engineer, Instructor & Mentor with extensive experience in mobile and web development. I actively contribute as a Mentor & Instructor at Dunia Coding and Superprof, as well as a General Mentor at the CompeteMate GDGOC Gunadarma University competition.

          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Currently, I work as a Full-time Mobile Developer while handling various freelance web and fullstack development projects. Beyond coding, I have published several articles on software engineering and received multiple awards in technology Olympiads. Passionate about knowledge-sharing and continuous innovation, I strive to empower developers and create impactful tech solutions. 
          </p>
        </div>
